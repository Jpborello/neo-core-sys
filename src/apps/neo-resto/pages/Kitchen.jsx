    ...
    useEffect(() => {
        const fetchOrders = async () => {
            const { data } = await supabase
                ...
                .eq('restaurant_id', 'd3b07384-d9a9-4152-87c9-7d8e1327f31c') // Strict filtering
        ...
        const channel = supabase
            ...
            .on(
                'postgres_changes',
                { event: 'INSERT', schema: 'public', table: 'orders', filter: 'restaurant_id=eq.d3b07384-d9a9-4152-87c9-7d8e1327f31c' },
                (payload) => {
                    // Double check in case filter fails or logic changes
                    if (payload.new.restaurant_id !== 'd3b07384-d9a9-4152-87c9-7d8e1327f31c') return;
