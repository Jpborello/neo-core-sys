...
export default function Home() {
    ...
    return (
        <div className="bg-[#0a192f]">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                    <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <h2 className="text-[#d4af37] font-bold tracking-[0.5em] uppercase mb-4 text-sm md:text-base">Nueva Colección 2025</h2>
                        <h1 className="text-5xl md:text-8xl font-black text-white mb-8 uppercase tracking-tighter leading-none">
                            Redefine tu <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">Estilo</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/demo-all-inclusive/catalogo" className="bg-white text-[#0a192f] px-10 py-4 font-bold uppercase tracking-widest hover:bg-[#d4af37] transition-colors duration-300">
                                Ver Colección
                            </Link>
                            <Link to="/demo-all-inclusive/contacto" className="border border-white text-white px-10 py-4 font-bold uppercase tracking-widest hover:bg-white hover:text-[#0a192f] transition-colors duration-300">
                                Contacto
                            </Link>
                        </div>
                    </motion.div>
            ...
            {/* Features Banner */}
            <div className="bg-[#050d1a] py-12 border-y border-[#d4af37]/20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        <div className="flex flex-col items-center gap-4">
                            <FaShippingFast className="text-[#d4af37] text-3xl" />
                        ...
                        <div className="flex flex-col items-center gap-4">
                            <FaUndo className="text-[#d4af37] text-3xl" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {featuredProducts.map(product => (
                            <div key={product.id} className="group cursor-pointer">
                                <div className="relative aspect-[3/4] overflow-hidden bg-[#050d1a] mb-6">
                                    <img src={product.image} alt={product.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                                    {product.isNew && (
                                        <div className="absolute top-4 left-4 bg-[#d4af37] text-[#0a192f] text-xs font-bold px-3 py-1 uppercase tracking-widest">New</div>
                                    )}
                                    <div className="absolute inset-0 bg-[#0a192f]/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                        <Link to="/demo-all-inclusive/catalogo" className="bg-white text-[#0a192f] px-8 py-3 font-bold uppercase tracking-widest hover:bg-[#d4af37] transition-colors transform translate-y-4 group-hover:translate-y-0 duration-300">
                                            Ver Detalle
                                        </Link>
                                    </div>
                                </div>
            ...
            <section className="py-24 bg-[#050d1a] overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="relative">
                            <div className="absolute -top-10 -left-10 w-40 h-40 border-2 border-[#d4af37]/20 z-0"></div>
                            ...
                            <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-[#d4af37]/10 z-0"></div>
                        </div>
                        <div>
                            <h2 className="text-[#d4af37] font-bold tracking-[0.5em] uppercase mb-4 text-sm">Lifestyle</h2>
                            ...
                            <Link to="/demo-all-inclusive/nosotros" className="text-white border-b border-[#d4af37] pb-1 hover:text-[#d4af37] transition-colors uppercase tracking-widest text-sm font-bold">
                                Nuestra Historia
                            </Link>
                        </div>
                    </div>
