    ...
    return (
        <div className="bg-[#0a192f] min-h-screen pt-24 pb-24">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="aspect-video w-full bg-[#050d1a] mb-12 overflow-hidden relative">
                    <img
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    <div>
                        ...
                        <div className="space-y-8">
                            <div>
                                <h3 className="text-[#d4af37] font-bold uppercase tracking-widest mb-2">Showroom</h3>
                                <p className="text-white">Mendoza 6440<br />Rosario, Santa Fe</p>
                            </div>
                            <div>
                                <h3 className="text-[#d4af37] font-bold uppercase tracking-widest mb-2">WhatsApp</h3>
                                <p className="text-white">+54 341 284-4169</p>
                            </div>
                            <div>
                                <h3 className="text-[#d4af37] font-bold uppercase tracking-widest mb-2">Redes</h3>
                                <p className="text-white">@allinclusiveindumentaria</p>
                            </div>
                        </div>
                    </div>

                    <div className="bg-[#050d1a] p-8 md:p-12 border border-white/10">
                        <form className="space-y-6">
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">Nombre</label>
                                <input type="text" className="w-full bg-[#0a192f] border border-gray-800 text-white p-4 focus:border-[#d4af37] focus:outline-none transition-colors" placeholder="TU NOMBRE" />
                            </div>
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">Email</label>
                                <input type="email" className="w-full bg-[#0a192f] border border-gray-800 text-white p-4 focus:border-[#d4af37] focus:outline-none transition-colors" placeholder="TU EMAIL" />
                            </div>
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">Mensaje</label>
                                <textarea rows="4" className="w-full bg-[#0a192f] border border-gray-800 text-white p-4 focus:border-[#d4af37] focus:outline-none transition-colors" placeholder="¿EN QUÉ PODEMOS AYUDARTE?"></textarea>
                            </div>
                            <button type="button" className="w-full bg-white text-[#0a192f] py-4 font-bold uppercase tracking-widest hover:bg-[#d4af37] transition-colors">
                                Enviar Mensaje
                            </button>
                        </form>
                    </div>
