                                        ...
                                        className={`
                                            ...
                                            ${isPaying || isCash
                                                ...
                                                : tState.needs_assistance
                                                    ? 'bg-violet-900/20 border-violet-500 hover:bg-violet-900/30'
                                                    : tState.request_bill
                                                        ? 'bg-orange-900/20 border-orange-500 hover:bg-orange-900/30'
                                                        : tState.status === 'occupied' ? 'bg-neutral-800 border-neutral-600' : 'bg-neutral-800/50 border-neutral-700 hover:bg-neutral-750'
                                            }
                                        `}
                                    >
                                        <div className="flex justify-between w-full">
                                            <span className="text-3xl font-bold opacity-50">{num}</span>
                                            <div className="flex flex-col gap-1 items-end">
                                                {tState.needs_assistance && (
                                                    <div onClick={(e) => { e.stopPropagation(); handleResolveAssistance(num) }} className="bg-violet-600 text-white text-[10px] p-1 rounded animate-pulse cursor-pointer flex items-center gap-1 hover:bg-violet-500">
                                        ...
                                        <div className="flex flex-col gap-1 w-full">
                                            {isCash ? (
                                                ...
                                                tState.request_bill ? (
                                                    ...
                                                    <span className={`text-xs font-bold uppercase ${hasAlerts ? 'text-amber-500' : 'text-neutral-500'}`}>
                                                        {hasAlerts ? 'Atención' : 'Sin Novedad'}
                                                    </span>
                                                )
                                            )}
                                        </div>
